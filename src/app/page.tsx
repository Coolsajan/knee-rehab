    ...
    <div className="min-h-screen" style={{ background: 'var(--bg)' }}>
      <div className="max-w-2xl mx-auto px-4 pt-8">
        ...
        <div className="flex gap-2 mb-6 p-1 rounded-xl" style={{ background: 'var(--bg2)', border: '1px solid var(--border)' }}>
          <button onClick={() => setActiveTab('knee')} className="flex-1 py-2 rounded-lg text-sm font-medium"
    ...
    <div className="min-h-screen" style={{ background: 'var(--bg)' }}>
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-2 mb-6 p-1 rounded-xl" style={{ background: 'var(--bg2)', border: '1px solid var(--border)' }}>
          ...
          <button onClick={() => setActiveTab('abs')} className="flex-1 py-2 rounded-lg text-sm font-medium"
            style={{ background: 'transparent', color: 'var(--text-muted)', border: 'none', cursor: 'pointer' }}>
            💪 Abs
          </button>
        </div>
